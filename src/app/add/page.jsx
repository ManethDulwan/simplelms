    ...
    return (
        <div className="flex justify-center items-center">
            <div className="border rounded-[25px] p-14 mt-20">
                <h1 className="text-center font-bold">ADD Students</h1>
                ...
                <button onClick={handleSubmit} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-[25px]">Add Student</button>
            </div>
        </div>
    );
}